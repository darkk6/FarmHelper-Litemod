...
public class GuiFarmhelperConfig extends Gui implements ConfigPanel {
	...
	public void onPanelShown(ConfigPanelHost host) {
		...
		if(txt==null || lb==null){
			...
			lb=new GuiLabel(mc.fontRendererObj, 100, wCenter+10,10,strWidth,fontHeight+4,0xFFFFFFFF);
			lb.addLine(tmp);
			theLabelWidth=strWidth;
			
			txt=new GuiTextField(101, mc.fontRendererObj,wCenter+strWidth+15,10,50,fontHeight+4);
